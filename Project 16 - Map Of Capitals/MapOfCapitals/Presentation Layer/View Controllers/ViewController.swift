...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    private func initCapitals() {
        let hanoi = Capital(title: "Ha Noi", coordinate: CLLocationCoordinate2D(latitude: 21.028333, longitude: 105.854167), subtitle: "Capital of Viet Nam", wikipediaUrl: "https://en.wikipedia.org/wiki/hanoi")
        let london = Capital(title: "London", coordinate: CLLocationCoordinate2D(latitude: 51.507222, longitude: -0.1275), subtitle: "Home to the 2012 Summer Olympics.", wikipediaUrl: "https://en.wikipedia.org/wiki/london")
        let oslo = Capital(title: "Oslo", coordinate: CLLocationCoordinate2D(latitude: 59.95, longitude: 10.75), subtitle: "Founded over a thousand years ago.", wikipediaUrl: "https://en.wikipedia.org/wiki/oslo")
        let paris = Capital(title: "Paris", coordinate: CLLocationCoordinate2D(latitude: 48.8567, longitude: 2.3508), subtitle: "Often called the City of Light.", wikipediaUrl: "https://en.wikipedia.org/wiki/paris")
        let rome = Capital(title: "Rome", coordinate: CLLocationCoordinate2D(latitude: 41.9, longitude: 12.5), subtitle: "Has a whole country inside it.", wikipediaUrl: "https://en.wikipedia.org/wiki/rome")
        let washington = Capital(title: "Washington DC", coordinate: CLLocationCoordinate2D(latitude: 38.895111, longitude: -77.036667), subtitle: "Named after George himself.", wikipediaUrl: "https://en.wikipedia.org/wiki/Washington,_D.C.")
